...
var ActorDetailsComponent = (function () {
    ...
    ActorDetailsComponent.prototype.filmographyLoading = function (event) {
        console.log("list loading");
        console.log(event);
    };
    ActorDetailsComponent.prototype.filmographyLoaded = function (event) {
...
ActorDetailsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [router_1.ActivatedRoute,
        router_2.Router,
        common_1.Location,
        people_search_service_1.PeopleSearchService])
